...
from .intents import PythonFileIntent, PythonTemplateIntent, PythonProjectIntent, PythonProjectIntentV2, intent_from_dict
...
class PlannerManager:
    ...
    def validate_intent_plan(self, objective, intent):
        if type(intent) not in (PythonFileIntent, PythonTemplateIntent, PythonProjectIntent, PythonProjectIntentV2):
    ...
    def plan_intent(self, objective, intent):
        ...
        plan = Plan(objective)
        description = "Build and verify one Python project" if isinstance(intent, (PythonProjectIntent, PythonProjectIntentV2)) else "Build and verify one Python file"
